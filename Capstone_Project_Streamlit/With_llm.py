...
# genai.configure(api_key="AIzaSyDONU1LmKi9fVNEG9tsopZvRB0EcdKcfs8")'AIzaSyCNgcmnCCA81fPQWX_WL7Z786w-fOiankE'
	# Get OpenAI API key from user
gemini_api_key = st.text_input("Enter your GeminiAI API key:", type="password")
if gemini_api_key:     
...
directory_path = r"S:\HomeSmiles\JPythonF\ISBCapstoneJ\dataredaction\ISB_Project\pdf"
